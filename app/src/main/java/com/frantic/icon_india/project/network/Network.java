package com.frantic.icon_india.project.network;
...
import com.frantic.icon_india.project.application.VolleyApplication;
    ...
    public void requestWithJsonObject(final String url, Object object, final VolleyResponse vr) {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, url, json, new Response.Listener<JSONObject>() {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                ...
                params.put("Content-Type", "application/json;charset;charset=utf-8");
